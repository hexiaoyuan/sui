...
git fetch upstream
git switch -c sui-v1.11_pt01  upstream/releases/sui-v1.11.0-release

### fork from upstream-tag:
#git fetch upstream refs/tags/mainnet-v1.11.2:refs/tags/mainnet-v1.11.2
#git switch -c sui-v1.11_pt01 mainnet-v1.11.2
...
#
#
git clone --branch sui-v1.11_pt01 git@github.com:hexiaoyuan/sui.git
