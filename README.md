...
git fetch upstream
git switch -c sui-v1.17_pt01  upstream/releases/sui-v1.17.0-release
### fork from upstream-tag:
#git fetch upstream refs/tags/mainnet-v1.17.3:refs/tags/mainnet-v1.17.3
#git switch -c sui-v1.17_pt01 mainnet-v1.17.3
#
git push --set-upstream origin
#
#... merge diff to view ...
https://github.com/MystenLabs/sui/compare/releases/sui-v1.17.0-release...hexiaoyuan:sui:sui-v1.17_pt01
#......
#
...
#
#
git clone --branch sui-v1.17_pt01 git@github.com:hexiaoyuan/sui.git
